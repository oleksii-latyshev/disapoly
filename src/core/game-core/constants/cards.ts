// Chance and Community Chest decks. Effects are data the reducer executes;
// card text is localized on the client via the i18n key `card.<id>`.

import type { MoveTarget } from "./board"
