...
3. ✅ **Stage 2 — Full rules.**
   - ✅ Part 1 — economy: house/hotel building (with even-building), mortgage/unmortgage, proper bankruptcy via automatic asset liquidation. *(reducer + `ManagePanel`, board renders houses/mortgages.)*
   - ✅ Part 2:
